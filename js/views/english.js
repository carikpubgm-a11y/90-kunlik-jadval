...
export class EnglishView {
    constructor() {
        this.title = 'Ingliz Tili Yo\'nalishi';
    ...
    render() {
        ...
        const mission = curriculumEngine.getMission(currentDay, 'english');

        if (!mission) {
            return `
                <div class="view-container">
                    <h1>Ingliz Tili Ustaligi</h1>
        ...
        return `
            <div class="view-container animate-in">
                <header class="view-header">
                    <h1>Ingliz Tili Ustaligi <span class="text-gradient">${currentDay}-Kun</span></h1>
                    <p class="subtitle">Lug'at boyligi, Grammatika, O'qish, Eshitish va Gapirish</p>
                </header>
                ...
                <div class="mission-details-card">
                    ...
                    <div class="mission-content" style="margin-bottom: 24px; line-height: 1.6;">
                        ...
                        <p>${mission.description || 'Bugungi ingliz tili vazifasini yakunlang.'}</p>
                    </div>

                    <!-- Simulated Sub-tasks based on requirement -->
                    <div class="sub-tasks" style="margin-bottom: 24px; display: grid; gap: 8px;">
                        <div style="padding: 12px; background: var(--card-bg); border-radius: 8px; display: flex; align-items: center; gap: 12px;">
                            <span>📖</span> <strong>Lug'at va Grammatika</strong>
                        </div>
                        <div style="padding: 12px; background: var(--card-bg); border-radius: 8px; display: flex; align-items: center; gap: 12px;">
                            <span>🎧</span> <strong>Eshitish Mashqi</strong>
                        </div>
                        <div style="padding: 12px; background: var(--card-bg); border-radius: 8px; display: flex; align-items: center; gap: 12px;">
                            <span>🗣️</span> <strong>Gapirish va Talaffuz</strong>
                        </div>
                    </div>
                    ...
                    ` : `
                        <button class="btn btn-primary btn-large complete-btn" style="width: 100%" data-mission-id="${mission.id}" data-day="${currentDay}" data-track="english">
